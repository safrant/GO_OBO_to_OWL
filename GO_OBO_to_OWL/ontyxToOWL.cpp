...
#include "ontyxToOWL.h"


ontyxToOWL::ontyxToOWL (const int argc,const char * argv[]) 
{  
	otoo_Notmain(argc, argv);
}

ontyxToOWL::~ontyxToOWL (void)
{
	;
}
...
int otoo_Notmain (int argc, char * argv[])
{
